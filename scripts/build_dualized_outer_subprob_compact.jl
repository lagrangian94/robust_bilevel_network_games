...
"""
function build_dualized_outer_subproblem_compact(network, S, ϕU_hat, ϕU_tilde, λU, γ, w, v, uncertainty_set, optimizer, λ, x, h, ψ0; πU_hat=ϕU_hat, πU_tilde=ϕU_tilde, yU=ϕU_tilde, ytsU=ϕU_tilde)
