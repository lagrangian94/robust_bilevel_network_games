"""
plot_grid5x5_modes.jl — Grid 5x5 γ=1 λU=10.0, same_alpha vs diff_alpha 비교.
oos_phase_b_generic 사용 (follower 독립 샘플링).
x_nom=[22] vs x_rob=[25]
"""
...
# ============================================================
# Grid 5x5 setup — original interdictable arcs (NOT all-intd)
# ============================================================
...
for mode in [:same_alpha, :diff_alpha]
    ...
    for β in β_list
        ...
        fname = @sprintf("true_dro/factor_5/plots/grid5x5_boxplot_%s_beta%.1f.png", mode, β)
        title = @sprintf("Grid 5x5 OOS [%s] (β=%.1f, γ=1, λU=10)", mode, β)
