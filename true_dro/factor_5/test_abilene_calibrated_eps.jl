"""
test_abilene_calibrated_eps.jl — abilene, all-intd, γ=1, λU=10.0, ε=0.565674 (calibrated)
Nominal: Benders ε=0, Robust: Benders ε=0.565674
"""
...
@printf("abilene ALL intd k=5: arcs=%d, intd=%d, γ=%d, λU=%.1f, ε=%.6f, w=%.4f\n",
