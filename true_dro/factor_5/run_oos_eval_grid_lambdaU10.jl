"""
run_oos_eval_grid_lambdaU10.jl — Grid 5x5 γ=1 λU=10.0 OOS Phase B 평가.
...
# ============================================================
# Grid 5x5 γ=1 λU=10.0, original interdictable arcs
# ============================================================
...
for a in [22]; x_nom[a] = 1.0; end
x_rob = zeros(Float64, num_arcs)
for a in [25]; x_rob[a] = 1.0; end

println("=" ^ 80)
println("OOS Phase B — Grid 5x5 γ=1 λU=10.0 (original intd)")
@printf("  x_nom=[22], x_rob=[25], w=%.4f\n", w)
