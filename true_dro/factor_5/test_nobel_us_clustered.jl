...
caps, F_mat = generate_capacity_scenarios_factor_clustered(length(net.arcs), 20;
    interdictable_arcs=net.interdictable_arcs, seed=42, num_factors=5, N_pool=2000)
...
@printf("nobel_us clustered k=5: arcs=%d, intd=%d, γ=%d, w=%.4f\n", num_arcs, length(intd_idx), γ, w)
flush(stdout)
